...
const OPTIONAL_ENV = [
  ...
  'PLAID_CLIENT_ID_DEBT', 'PLAID_SECRET_DEBT', 'PLAID_ENV_DEBT',
  'VAPID_PUBLIC_KEY', 'VAPID_PRIVATE_KEY', 'ANTHROPIC_API_KEY', 'ANTHROPIC_API_KEY_DEBT', 'CRON_SECRET', 'ADMIN_SECRET',
